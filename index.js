...
module.exports.ImageWatermark = {
	createResizedImage: (path, width, height, format, quality, rotation = 0, outputPath) => {
		console.log('RNImageWatermark=createResizedImage=', RNImageWatermark);
  ...
  addImageWatermark: (path, str='水印', positionstr='5', outputPath) => {
    return new Promise((resolve, reject) => {
    	console.log('RNImageWatermark=addImageWatermark=', RNImageWatermark);
